...
def test_Factor_duration(test):
	...
	day = module.libtime.Measure.of(day=1)
	test/f.duration(None, str(int(day))) == '24 hours'

	c = module.libtime.Measure.of(day=1, minute=24, second=17, millisecond=403, microsecond=23)
	test/f.duration(None, str(int(c))) == '24 hours 24 minutes 17s 403ms 23µs'

	c = module.libtime.Measure.of(second=17, millisecond=403, microsecond=0, nanosecond=100)
